...
public class Maps01 {
    ...
    public static void main(String[] args) {
        ...
        // Size verilen bir cumledeki her kelimenin kac kere kullanildiginiz gosteren kodu yaziniz
        ...
        // Kelimeleri almak icin split methodunu kullancaz
        String[] kelimeler = str.split(" ");
        System.out.println(Arrays.toString(kelimeler)); // [I, like, to, move, it, move, it]

        HashMap<String,Integer> gorunum = new HashMap<>(); // {            } map bu haliyle bombos loopda icine kelime ekleniyo


                        // I like to move it move it
        for (String w:kelimeler ){

            Integer gorunumSayisi = gorunum.get(w); // bu mapde kullanilmissa kullanim sayisini kullanilmadiysa null verecek
